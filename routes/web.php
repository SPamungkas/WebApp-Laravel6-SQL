...
Route::get('/barang', 'barangcontroller@index')->middleware('role:admin');
Route::post('delete', 'barangcontroller@delete')->name('barang.delete');
Route::post('updates','barangcontroller@update')->name('barang.update');
Route::post('/barang', 'barangcontroller@store')->name('barang.store');

Route::get('/HistoryPesanan', 'HistoryPesanan@index')->middleware('role:admin');
Route::post('updatess','HistoryPesanan@update')->name('historyadmin.update');